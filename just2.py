# This updated code adds unsupervised niche discovery via clustering on CLIP embeddings.
# It extracts embeddings from video frames, clusters them into niches, and saves results.
# Predefined niches are not needed; clusters are labeled as "niche_0", "niche_1", etc.
# You can manually inspect and rename clusters later.
# Checkpointing, CSV/JSON output, and /tmp remain.
...
folder_path = "/content/drive/MyDrive/reels/"
...
# Step 11: Perform clustering to discover niches
num_clusters = 10  # Set number of niches (clusters); adjust or use elbow method for auto
if all_embeddings.size == 0:
    ...
    print(f"Clustering complete. Found {num_clusters} niches. Results saved to {output_csv} and {output_json}")
